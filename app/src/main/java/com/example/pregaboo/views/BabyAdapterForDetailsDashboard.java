...
public class BabyAdapterForDetailsDashboard extends RecyclerView.Adapter<BabyAdapterForDetailsDashboard.BabyViewHolder> {
    private List<Baby> babyList;
    private Context context;
    private String userId;

    public BabyAdapterForDetailsDashboard(List<Baby> babyList, Context context, String userId) {
