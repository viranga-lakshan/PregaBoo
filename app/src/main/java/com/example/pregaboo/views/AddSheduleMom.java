...
public class AddSheduleMom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_shedule_mom);
    ...
    private void saveClinicDate() {
        ...
        db.collection("users")
                .document(userId)
                .collection("MomClinicSchedule")
                .add(clinicData)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(AddSheduleMom.this, "Clinic date saved successfully", Toast.LENGTH_SHORT).show();
                    purposeInput.setText("");
                    loadClinicDates();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(AddSheduleMom.this, "Error saving clinic date: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
        ...
        db.collection("users")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(AddSheduleMom.this, "Error loading clinic dates.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}