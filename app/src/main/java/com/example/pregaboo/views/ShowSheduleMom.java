...
public class ShowSheduleMom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_shedule_mom);
        ...
        db.collection("users")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(ShowSheduleMom.this, "Error loading clinic dates.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}